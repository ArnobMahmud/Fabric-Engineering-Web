          ...
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-xl-5 col-md-6 col-sm-12">
              <ResourceTreeCard
                ...
                content="Statistics, Fiber & Yarn Testing (FYT), Man-made Textile Fibers (MMTF), Yarn Manufacturing I (YM I), Weaving Preparatory Process (WPP), Fundamentals of Mechanical Engineering (FME)"
