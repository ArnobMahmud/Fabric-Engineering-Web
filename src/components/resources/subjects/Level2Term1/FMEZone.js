...
const FMEZone = () => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.herokuapp.com/api/v1/notes/fme2-1"
        )
        .then((response) => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.herokuapp.com/api/v1/resources/fme2-1"
        )
        .then((response) => {
          ...
          <div className="row justify-content-center">
            <div className="card col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div className="section-title">
                <h1>Fundamentals of Mechanical Engineering (FME)</h1>
              </div>
              <input
                type="text"
