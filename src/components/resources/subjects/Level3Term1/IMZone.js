...
const IMZone = () => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.onrender.com/api/v1/notes/im3-1"
        )
        .then((response) => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.onrender.com/api/v1/resources/im3-1"
        )
        .then((response) => {
          ...
          <div className="row justify-content-center">
            <div className="card col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div className="section-title">
                <h1>Industrial Management (IM)</h1>
              </div>
              <input
                type="text"
