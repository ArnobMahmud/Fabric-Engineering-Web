...
const KnitIZone = () => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.onrender.com/api/v1/notes/knit3-1"
        )
        .then((response) => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.onrender.com/api/v1/resources/knit3-1"
        )
        .then((response) => {
