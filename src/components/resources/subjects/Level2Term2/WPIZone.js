...
const WPIZone = () => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.onrender.com/api/v1/notes/wp2-2"
        )
        .then((response) => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.onrender.com/api/v1/resources/wp2-2"
        )
        .then((response) => {
