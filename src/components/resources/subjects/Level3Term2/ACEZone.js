...
const ACEZone = () => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.onrender.com/api/v1/notes/ace3-2"
        )
        .then((response) => {
  ...
  useEffect(() => {
    ...
    const timing = setTimeout(() => {
      axios
        .get(
          "https://fabric-web-backend-server.onrender.com/api/v1/resources/ace3-2"
        )
        .then((response) => {
          ...
          <div className="row justify-content-center">
            <div className="card col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div className="section-title">
                <h1>Automation & Control Engineering (ACE)</h1>
              </div>
              <input
                type="text"
